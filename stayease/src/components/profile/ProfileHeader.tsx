    ...
    <header className="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-solid border-[#e7edf3] bg-white px-4 py-3 md:px-10 shadow-sm">
      ...
      <div className="flex items-center justify-end gap-4 md:gap-8">
        ...
        <div className="flex items-center gap-3">
          <span className="text-sm font-medium hidden sm:block">Minh Nguyễn</span>
          <div 
            ...
            style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuDEVo4ajHUihBlJYshx3YW16eZoDUwtVItNNXKt954oQMSKoZKvQ8lO3qdsSDy4mX188lc8fdBJQptlXHZ60x6HvKQ8OB0ZVEqKlP6Hs1CHZGTp0_saDFWmB7cFgaNxx147QXRw2-wAhForBmrazgW5eEXHgOuJ9yAqwRvry8vmiRD_KiYZsQT9Zw7aUoHNmc_K29RDmm_tkrApQpQCTQMCUNYw9fGXw_UuFRTjGX8vKYR6J3LBtVP2a8NfN7lJAw6Iy0h5TKvT7ho")' }}
          ></div>
        </div>
      </div>
    </header>
